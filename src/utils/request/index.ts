...
export const GET = <T, R = FetchResponse<T>>(
  url: string,
  data?: ImageListParams
): Promise<R> => {
...
export const PUT = <T, R = FetchResponse<T>>(
  url: string,
  data: {}
): Promise<R> => {
...
export const DELETE = <T, R = FetchResponse<T>>(
  url: string,
  data: FetchRequestConfig<any> | undefined
) => {
